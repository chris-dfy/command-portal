...
export function OperationalAccessGate({
  ...
  return <section className="operational-access-gate" aria-labelledby="operational-access-title">
    ...
    <div>
      ...
      <p>Authenticate as the named operator whose identity, role, and permissions will be bound to Runtime Authority and execution receipts.</p>
    </div>
    ...
    <p className="boundary-note">The key is exchanged for an HttpOnly, scoped session and is never stored in browser storage. Authentication does not itself grant operational Authority.</p>
  </section>;
}
