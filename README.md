...
- A persistent NEXUS executive copilot remains available across Operations Center, Document Intelligence, Nexicron Projects, Mission Control, topology, providers, and evidence views. It carries one conversation ID, supports Runtime-governed text and Realtime voice, and presents model-native limitations without assembling Operational Context in the browser.
